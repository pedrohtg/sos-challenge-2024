...
class StreetObstacles:
    ...
    def __init__(
        ...
        self.ood_classes = np.arange(242, 255)  # np.arange(244, 255)
        self.id_dict = {
            "sequence_001": [1],
            "sequence_002": [1],
            "sequence_003": [1],
        ...
        for sequence in self.sequences:
            ...
            for basename in sequence_basenames:
                ...
                self.images.append(
                    str(sequence_images_dir / f"{Path(basename).stem}_raw_data.jpg")
                )
                ...
                self.targets_depth_ood.append(
                    str(sequence_depth_ood_dir / f"{Path(basename).stem}_depth_ood.png")
                )
    ...
    def __getitem__(self, index: int) -> Tuple[Any, Any]:
        ...
        for target_type in self.target_type:
            if target_type == "semantic_ood":
                ...
                target = read_image(self.targets_depth_ood[index], True)
